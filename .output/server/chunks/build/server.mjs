...
const _routes = [
  {
    name: "menu",
    path: "/menu",
    component: () => import('./menu-CfvDxjAz.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-UVtlEW8w.mjs')
  },
  {
    name: "historial",
    path: "/historial",
    component: () => import('./historial-D1hl1rGZ.mjs')
  },
  {
    name: "formulario",
    path: "/formulario",
    component: () => import('./formulario-CmL56AJq.mjs')
  },
  {
    name: "ClienteCreate",
    path: "/ClienteCreate",
    component: () => import('./ClienteCreate-DhtG46c5.mjs')
  },
  {
    name: "verformulario-id",
    path: "/verformulario/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_id_-BpnIkPqR.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CuQt7vQH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DBjDZqKs.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, entry$1 as default, createError as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
